...
MNEMONICS_DISASSEM_SYMBOLS_HEADER = "static const char *sym_mnemonics[256] = {"
...
#######################################################################################################################
###############################  Convert opcode structure to named symbol mnemonic  ###################################
#######################################################################################################################
def convertSymbolMnemonic(opInfo):
    modeStr = {
        "imp": "",
        "imp8": "#%s",
        "imm8": "#%s",
...
if __name__ == '__main__':
    ...
    # TODO: different symbols for 65c02 and 65c816
    symbols = [convertSymbolMnemonic(opcodesList_c02[x]) for x in range(0, TOTAL_NUMBER_OPCODES)]
    with open(MNEMONICS_DISASSEM_HEADER_FNAME, "w") as output_h_file:
        ...
        generateList(output_h_file, MNEMONICS_DISASSEM_SYMBOLS_HEADER, symbols)
